...
export function DraftEditor({ draft }: { draft: NotificationDraft }) {
  ...
  return (
    <div className="grid w-full grid-cols-1 gap-0 overflow-hidden lg:grid-cols-12">
      {/* BRIEF — left column */}
      <aside className="overflow-y-auto border-r border-neutral-200 bg-neutral-50/60 lg:col-span-3">
        <div className="p-5">
          ...
          <div className="mt-4 space-y-3">
            ...
            <TextareaField
              ...
              value={brief.context ?? ""}
              placeholder="Ej. La carga es para el segmento ONE; énfasis en seguridad."
          ...
          <button
            ...
            className="bg-brand-600 hover:bg-brand-700 mt-4 inline-flex w-full items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition disabled:cursor-not-allowed disabled:opacity-60"
          >
            {busy.generate ? (
              <>
      ...
      {/* COPY — center column */}
      <section className="overflow-y-auto border-r border-neutral-200 bg-white lg:col-span-5">
        <div className="p-6">
          <h2 className="text-[11px] font-semibold tracking-wider text-neutral-500 uppercase">
            Copy editable
          </h2>
            ...
            {imageResults.length > 0 && (
              <div className="mt-3 grid grid-cols-3 gap-2">
                {imageResults.map((img) => (
                  ...
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={img.thumbUrl} alt={img.title} className="h-20 w-full object-cover" />
                  </button>
                ))}
              </div>
            )}
      ...
      <section className="overflow-y-auto bg-neutral-100 lg:col-span-4">
        <div className="p-5">
          ...
          <div className="mt-3 overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm">
            <iframe
              title="Email preview"
              srcDoc={previewHtml}
              className="block h-[calc(100vh-10rem)] w-full border-0"
