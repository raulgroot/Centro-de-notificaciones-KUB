...
FROM f, (VALUES
  ...
  (2,
   ...
   '/flows/redireccion/email-creada.png'),
  ...
  (6,
   ...
   '["Campo de 6 dígitos para el OTP","Si inició por SMS, el OTP llega por email y viceversa","Validación en tiempo real del código"]',
  ...
  (10,
   ...
   '/flows/redireccion/email-exito.png')
